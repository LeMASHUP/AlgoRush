...
public:
	...
	bool updateVictory(sf::RenderWindow* window, sf::Event* event, Level1* level1, Level2* level2, int& state, int& previousLevelState, bool& levelCreated, bool& menuCreated);
